...
REGISTRY: dict[str, DecisionSpec] = {
    d.code: d for d in [
        ...
        DecisionSpec("2.4", "G2", "Free-shipping threshold", "curr", 2500,
                     frozenset({"foundation", "standard", "advanced", "expert"})),
        DecisionSpec("3.1", "G3", "Meta spend", "curr", 519_000,
                     frozenset({"foundation", "standard", "advanced", "expert"})),
        DecisionSpec("3.2", "G3", "Google Search spend", "curr", 260_000,
                     frozenset({"foundation", "standard", "advanced", "expert"})),
        DecisionSpec("3.4", "G3", "TikTok spend", "curr", 186_000,
                     frozenset({"foundation", "standard", "advanced", "expert"})),
        DecisionSpec("3.8", "G3", "Creative production budget", "curr", 222_000,
                     frozenset({"standard", "advanced", "expert"}), unlock_round=2),
        DecisionSpec("3.9", "G3", "Brand spend", "curr", 296_000,
                     frozenset({"standard", "advanced", "expert"}), unlock_round=2),
